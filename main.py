...
def main(config_path):
    ...
    controller.handle(f"spaghetti {ValueType.SSQ_DISORIENTATION.name}")
    controller.handle(f"spaghetti {ValueType.SSQ_NAUSEA.name}")
    controller.handle(f"spaghetti {ValueType.SSQ_OCULOMOTOR.name}")
    controller.handle(f"spaghetti {ValueType.SSQ_TOTAL.name}")
